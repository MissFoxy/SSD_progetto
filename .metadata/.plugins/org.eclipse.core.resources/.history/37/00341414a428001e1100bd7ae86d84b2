...
public class ImpiantoA {
	...
	//private HashMap<tipoPezzo, Integer> listaPezzi; //contiene il tipo pezzo M1, M2 e il numero di pezzi da costruire
	...
	public ImpiantoA(String nome, int seed, long endTime) {
		...
		//listaPezzi = new HashMap<tipoPezzo, Integer>();
	...
	*/
	public void addPezzi(int M1, int M2) {
	...
	public void startFederate(String host) {
		...
		EventoRemotoA eventoRemotoA = new EventoRemotoA(EventType.STARTING_REQUEST, currentTime, listaPezzi);
	...
	private void process(EventoLocaleA e) {
		...
		currentTime = fedAmbassador.getFederateTime();
		attivita = eventsList.first().getAttivitaA();
